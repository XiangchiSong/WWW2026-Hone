...
For the theoretical analysis and mathematical derivation in Section 4.4 of this paper, please refer to *theoreticalAnalysis.pdf*. Specifically, it is the theoretical analysis and formula derivation of the theoretical list in Appendix D.
